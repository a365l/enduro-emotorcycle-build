...
The NBPower pack was always rated 100A - the Phase 0 generic 80A controller was the limiting factor, not the battery. With the Fardriver installed, the pack now runs within its rated envelope.

Key point: the battery was never the bottleneck. Replacing it in Phase 2 would have been wasted money.
...
If replacing the pack later, LiFePO4 is worth considering for the safety and cycle life gains - tradeoff is lower energy density so the pack will be bigger/heavier for the same capacity.
